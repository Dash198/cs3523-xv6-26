...
test_pa4_19(void)
{
    ...
    printf("  Sequential FCFS: reads=%d writes=%d avg_lat=%d.%d\n",
           st1.disk_reads, st1.disk_writes, st1.average_latency/100, st1.average_latency%100);
    ...
    printf("  Scattered SSTF: reads=%d writes=%d avg_lat=%d.%d\n",
           st2.disk_reads, st2.disk_writes, st2.average_latency/100, st2.average_latency%100);
